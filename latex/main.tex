...
Come anticipato nella precedente sezione, il prossimo passo \`e quello di definire correttamente il problema di M.L. ed utilizzare il giusto algoritmo di learning.
Per questi scopi bisogna preparare i dati estratti dai sensori per poter essere utilizzati efficacemente.
...
% Descrivere come viene simulato il process noise
