...
\end{itemize}
Nei diagrammi di entrambi i modelli, i rispettivi segnali di importanza per per questa fase sono stati segnati con un numero (ID del sensore) all'interno di un cerchio rosso e sono rispettivamente, 
